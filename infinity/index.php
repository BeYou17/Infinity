...
<body>
    <main>
        ...
        <section>
            <div class="message">
                <div class="content">
                    <h1>I Got Supplies.</h1>
                    <h1>Enimies Ahead.</h1>
                    <h1>Clutch Them.</h1>
                    <h1>GG....</h1>
                </div>
                <div class="download">
                    <a href=""><div class="playstore btn"><ion-icon name="logo-google-playstore"></ion-icon></div></a>
                    <a href=""><div class="appstore btn"><ion-icon name="logo-apple-appstore"></ion-icon></div></a>
                </div>
            </div>
        </section>
    </main>
